<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="BarangayBusinessClearanceDisapproved.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.BarangayBusinessClearanceDisapproved" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Denied Business Clearance</li>
      </ol>
    </nav>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Denied Business Clearance<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Denied Business Clearance</label>
                        <div class="input-group">
                        <asp:textbox ID="txtSearch" runat="server" placeholder="Search Barangay Business Clearance Application" required="" aria-describedby="emailHelp" class="form-control input-style" AutoPostBack="True" OnTextChanged="txtSearch_TextChanged" />
                            </div>
                        </div>
                                 ...
                                 <table class="table table-sm table-hover">
                                    <thead class="text-primary">
                                        <tr>
                                            ...
                                            <th style="border: 1px solid black">Business Address</th>
                                            
                                            <th style="border: 1px solid black">Business Clearance Control No</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 23%">
                                                ...
                                                <asp:Label ID="lblonwername" Text='<%#Eval("operatormanager") %>' runat="server" />
                                            </td>
                                            <td style="width: 15%">
                                              <asp:Label ID="lblbusinessname" Text='<%#Eval("businessname") %>' runat="server" /> 
                                            </td>
                                            <td style="width: 23%">
                                                <asp:Label ID="lblbusinessaddress" Text='<%#Eval("businessaddress") %>' runat="server" />
                                            </td>
                         
                                           
                                            <td style="width: 23%">
                                                <asp:Label ID="Label1" Text='<%#Eval("barangaybusinesscontrolno") %>' runat="server" />
                                            </td>
                                             <td style="width: 16%">
