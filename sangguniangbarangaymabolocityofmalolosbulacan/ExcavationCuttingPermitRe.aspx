<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="ExcavationCuttingPermitRe.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ExcavationCuttingPermitRe" %>
                ...
                <div class="container-fluid content-top-gap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb my-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Request Document For Excavation Cutting Permit</li>
                        </ol>
                    </nav>
                    ...
                    <section class="forms">
                        ...
                        <div class="card card_border py-2 mb-4">
                            <div class="cards__heading">
                                <h3>Request Document Excavation Cutting<span></span></h3>
                            </div>
                            <div class="card-body">
