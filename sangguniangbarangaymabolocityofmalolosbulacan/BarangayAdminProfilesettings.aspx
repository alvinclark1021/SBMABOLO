<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="BarangayAdminProfilesettings.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.BarangayAdminProfilesettings" %>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Profile Settings<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Fullname</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <asp:TextBox ID="txtemail" aria-describedby="emailHelp" class="form-control input-style" placeholder="Email" required="" runat="server" ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          <asp:TextBox ID="Txtbirthday" aria-describedby="emailHelp" class="form-control input-style" placeholder="Birthday" required="" runat="server" ReadOnly="True"></asp:TextBox>                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Address</label>
                        <div class="input-group">
                           <asp:TextBox ID="txtaddress" aria-describedby="emailHelp" class="form-control input-style" placeholder="Address" required="" runat="server"></asp:TextBox>                        </div>
                    </div>
                    <asp:Button ID="btnchangeprofile" class="btn btn-primary btn-style mt-4" OnClick="btnchangeprofile_Click" runat="server" Text="Update" />
                    </form>
                </div>
            </div>
            <!-- //forms 1 -->
