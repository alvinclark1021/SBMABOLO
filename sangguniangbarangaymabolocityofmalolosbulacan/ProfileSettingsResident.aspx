<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="ProfileSettingsResident.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ProfileSettingsResident" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <title>Profile Settings- Sangguniang Barangay Mabolo, Malolos City</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lbluser" Visible="false" runat="server" Text="Change Password"></asp:Label>
	 <body>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>My Profile<span></span><h3>Manage and protect your account</h3></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Your Registration No</label>
                        <div class="input-group">
                           <asp:Label ID="lblRegistrationNo" aria-describedby="emailHelp" class="form-control input-style"  runat="server" Text="Label" Font-Bold="True" Font-Size="Large"></asp:Label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Name: </label>
                        <div class="input-group">
                            <asp:TextBox ID="txtfullname" aria-describedby="emailHelp" class="form-control input-style"  placeholder="Fullname" required=""  runat="server"></asp:TextBox>
                        </div>
                    </div>
                        <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Mobile Number</label>
                        <div class="input-group">
                            <asp:TextBox ID="txtmobilenumber" aria-describedby="emailHelp" class="form-control input-style"  placeholder="Mobile Number" required="" runat="server" ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                           <asp:TextBox ID="txtaddress" aria-describedby="emailHelp" class="form-control input-style"   placeholder="Address" runat="server"></asp:TextBox>                    </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                           <asp:TextBox ID="txtdefaultaddress" ReadOnly="true" aria-describedby="emailHelp" class="form-control input-style"  placeholder="Address" runat="server"></asp:TextBox>                    </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnsubmitinformation" class="btn btn-primary btn-style mt-4" OnClick="btnupdateinformation_Click" OnClientClick="return confirm('Do you want to change your information ?')" runat="server" Text="Save" />
