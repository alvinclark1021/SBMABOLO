<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="barangayindigencyPending.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.barangayindigencyPending" %>
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Barangay Indigency</label>
                        <div class="input-group">
                            <asp:textbox ID="txtSearch" runat="server" aria-describedby="emailHelp" AutoPostBack="true" class="form-control input-style" placeholder="Search Control No" />
                    ...
                    <br />
                      ...
                      <asp:Repeater ID="rptbarangayindigencypending" runat="server">
                            <HeaderTemplate>
                                 <table class="table table-sm table-hover">
                                    <thead class="text-primary">
                                        <tr>
                                            ...
                                            <th style="border: 1px solid black">Document Request</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 20%">
                                              ...
                                              <asp:Label ID="lblidno" Text='<%#Eval("barangayControlnumber") %>' runat="server" /> 
                                            </td>
                                            <td style="width: 24%">
                                               
                                                <asp:Label ID="lblname" Text='<%#Eval("fullnames") %>' runat="server" />
                                            </td>
                                            ...
                                            <td style="width: 9%">
                                             ...
                                             <td style="width: 11%">
                                                <asp:Label ID="Label1" Text='<%#Eval("barangaycefication") %>' runat="server" />
                                            </td>
                                            <td style="width: 13%">
                                                <asp:linkbutton text="View" ID="lnkreviewwith24hours" runat="server" CssClass="btn-success" OnClick="lnkreviewwith24hours_Click"  />
                                            </td>
                                        </tr>
                            </ItemTemplate>
                            <FooterTemplate>
