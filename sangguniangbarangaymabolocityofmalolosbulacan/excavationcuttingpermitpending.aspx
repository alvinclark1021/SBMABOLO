<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="excavationcuttingpermitpending.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.excavationcuttingpermitpending" %>
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <%--<label for="exampleInputPassword1" class="input__label">Excavation Cutting Permit</label>--%>
                    ...
                    <br />
                      ...
                      <asp:Repeater ID="rptexcavationcuttingpermit" runat="server">
                            <HeaderTemplate>
