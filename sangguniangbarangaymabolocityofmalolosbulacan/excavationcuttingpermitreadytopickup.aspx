<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="excavationcuttingpermitreadytopickup.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.excavationcuttingpermitreadytopickup" %>
        ...
        <li class="menu-list">
          ...
          <ul class="sub-menu-list">
            <li><a href="excavationcuttingpermitpending.aspx">Pending</a> </li>
              ...
              <li><a href="excavationcuttingpermitclaim.aspx">Claiming</a> </li>
          </ul>
        </li>
