<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="occupancypermitopticalreceipt.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.occupancypermitopticalreceipt" %>
        ...
        <section>
            ...
            <div class="sidebar-menu sticky-sidebar-menu">
                ...
                <div class="logo-icon text-center">
                    <a href="ResidentDashboard.aspx" title="logo">
                                ...
                                <ul>
                                    <li class="dropdown profile_details_drop">
                                        ...
                                        <ul class="dropdown-menu drp-mnu" aria-labelledby="dropdownMenu3">
                                            <li class="user-info">
                                                <h5 class="user-name">
                                                    <asp:Label ID="lblname" runat="server" Text="fullname"></asp:Label></h5>
                                                <span class="status ml-2">Username:
                                                    <asp:Label ID="lblsessionlogin" runat="server" Text="Username"></asp:Label></span>
                                            </li>
                                            <li>
                                                <asp:LinkButton ID="linkprofile" OnClick="linkprofile_Click" class="fa fa-user" runat="server"> Profile</asp:LinkButton></li>
                                            <li>
                                                <asp:LinkButton ID="Linkchangepasswprd" OnClick="Linkchangepasswprd_Click" class="fa fa-lock" runat="server"> Change Password</asp:LinkButton></li>
                                            <li class="logout">
                ...
                <div class="container-fluid content-top-gap">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb my-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Request Document For Barangay Occupany Permit</li>
                        </ol>
                    </nav>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <asp:Button ID="btnsubmit" class="btn btn-primary btn-style mt-4" OnClick="btnsavepdf_Click" OnClientClick="return confirm('Do you want to download Ocupancy Permit recipient?')" runat="server" Text="Save as Pdf" />
                                                    <br />
                                                    <br />
