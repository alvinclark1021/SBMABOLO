<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="ClaimRequestedDocument.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ClaimRequestedDocument" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Claiming Documents</li>
      </ol>
    </nav>
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Claim Documents</label>
                        <div class="input-group">
                            <asp:textbox ID="txtSearch" runat="server" placeholder="Search" required="" aria-describedby="emailHelp" class="form-control input-style" AutoPostBack="True" OnTextChanged="txtSearch_TextChanged" />                            <div class="input-group-append">
                   ...
                   <asp:Button ID="Btnserachbar" class="btn btn-primary btn-style mt-4" OnClick="Btnserachbar_Click" runat="server" Text="Search" />
                       <br />
                    <br />
                     <asp:GridView ID="rptclaimingdocuments" AutoGenerateColumns="false" CssClass="table" runat="server">
                        <Columns>
                            <asp:BoundField HeaderText="Control No" DataField="barangayControlnumber" />
                            <asp:BoundField HeaderText="Name" DataField="fullname" />
                             <asp:BoundField HeaderText="Certification" DataField="barangaycefication" />
