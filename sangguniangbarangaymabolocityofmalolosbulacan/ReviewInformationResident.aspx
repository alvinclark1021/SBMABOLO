<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="ReviewInformationResident.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ReviewInformationResident" %>
      ...
      <!-- forms 1 -->
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Review Information Resident<span></span></h3>
                </div>
                <div class="card-body">
                    <form action="#" method="post">
                        <div class="form-group">
                            <label for="exampleInputEmail1" class="input__label">Resident No: </label>
                             <asp:Label ID="lblresidentno" runat="server" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Resident Address: </label>
                        ...
                        <div class="form-group">
                           ...
                           <asp:Label ID="lblbirthday" runat="server" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Sex: </label>
                          <asp:Label ID="lblgender" runat="server" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                        </div>
                       
                         <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Valid ID : </label>
                         

                        </div>
                        <div class="form-group">
                             <asp:Button ID="Btnreviewvalidid" class="btn btn-info" OnClick="Btnreviewvalidid_Click" ClientIDMode="Static" runat="server" Text="Review Valid ID" />
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Reasons:</label>
                     <asp:DropDownList ID="Dropmepuposes" aria-describedby="emailHelp" class="form-control input-style" required="" runat="server" Font-Bold="True" >
                    <asp:ListItem Text="Select Purpose and Reason" Value="Reason"></asp:ListItem>
                    <asp:ListItem Text="Resident's Information is Valid and Complete Requirements" Value="Validateme"></asp:ListItem>
                    <asp:ListItem Text="Your Valid ID must be replace due to blurry image or not readable" Value="RepalceID"></asp:ListItem>
                    <asp:ListItem Text="Non Resident of Barangay Mabolo" Value="NotResident"></asp:ListItem>
                    <asp:ListItem Text="Requirements are not complete" Value="Requirements"></asp:ListItem>
                   
                </asp:DropDownList>
                        </div>
                        <asp:Button ID="Btnapprovedordenied" class="btn btn-primary btn-style mt-4" OnClick="Btnapprovedordenied_Click" runat="server" Text="Submit" />
                    </form>
                </div>
            </div>
            <!-- //forms 1 -->
