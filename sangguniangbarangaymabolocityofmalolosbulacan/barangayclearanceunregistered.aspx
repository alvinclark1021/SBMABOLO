<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="barangayclearanceunregistered.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.barangayclearanceunregistered" %>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                    ...
                    <br />
                    <br />
                     <asp:Repeater ID="rptunderregisterdbusinessblearance" runat="server">
                            <HeaderTemplate>
