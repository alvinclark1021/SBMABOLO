<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="ResidencyRecipient.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ResidencyRecipient" %>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:Label ID="lbldatemenow" runat="server" aria-describedby="emailHelp" class="form-control input-style" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                         ...
                         <asp:Button ID="btnsubmit" class="btn btn-primary btn-style mt-4" OnClick="btnsavepdf_Click" OnClientClick="return confirm('Do you want to download Fencing Permit recipient?')" runat="server" Text="Submit" />
                         <br />
                         <br />
