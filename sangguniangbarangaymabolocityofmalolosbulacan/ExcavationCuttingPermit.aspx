<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="ExcavationCuttingPermit.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ExcavationCuttingPermit" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Request Document For Barangay Excavation / Cutting Permit</li>
      </ol>
    </nav>
   ...
   <asp:Label ID="lblID" runat="server" Text="Label" Visible="false" ForeColor="White"></asp:Label>
              ...
              <asp:Label ID="lblBarangayClearance" runat="server" Visible="false" Text="Barangay Excavation Permit" ForeColor="White"></asp:Label>
       <!-- forms -->
        <section class="forms">
            <!-- forms 1 -->
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Excavation / Cutting Permit<span></span></h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div id="da" runat="server" visible="false" class="form-group">
                    ...
                    <div id="daa" runat="server" visible="false" class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Email: </label>
                        <div class="input-group">
                             <asp:TextBox ID="txtemail" aria-describedby="emailHelp" class="form-control input-style" placeholder="Email Address" onfocus="this.type='email'" required="" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                        </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Address: </label>
                        <div class="input-group">
                                <asp:TextBox ID="txtaddress" aria-describedby="emailHelp" class="form-control input-style"  required="" runat="server" ReadOnly="True"></asp:TextBox>             
                            </div>
                        </div>
                        ...
                        <br />
                         ...
                         <br />
                                ...
                                <div class="form-group">
                                    ...
                                    <h5>Please Upload Your Plannning</h5>
                                    <br />
