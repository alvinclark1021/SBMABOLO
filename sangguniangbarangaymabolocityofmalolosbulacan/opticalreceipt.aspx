<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="opticalreceipt.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.opticalreceipt" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Receipt Request Documents Barangay Clearance - Sangguniang Barangay Mabolo, Malolos City</title>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          <asp:Label ID="lbltxtcontrolnumber" runat="server" aria-describedby="emailHelp" class="form-control input-style" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Name: </label>
                        <div class="input-group">
                             <asp:Label ID="lblfullnames" runat="server" Text="Label" aria-describedby="emailHelp" class="form-control input-style" Font-Bold="True" Font-Size="X-Large"></asp:Label>                    </div>
                        <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Mobile Number</label>
                        <div class="input-group">
                        <asp:Label ID="lblcontactnumber" runat="server" Text="Label" aria-describedby="emailHelp" class="form-control input-style" Font-Bold="True" Font-Size="X-Large"></asp:Label>                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Email: </label>
                        <div class="input-group">
                      <asp:Label ID="lblemail" runat="server" Text="Label" aria-describedby="emailHelp" class="form-control input-style" Font-Bold="True" Font-Size="X-Large"></asp:Label>                    </div>
                     <div class="form-group">
                        ...
                        <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Purposes: </label>
                        <div class="input-group">
                        <asp:Label ID="lblpurposes" runat="server" aria-describedby="emailHelp" class="form-control input-style" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                    ...
                    <div class="form-group">
                        ...
                        <asp:Label ID="lbldatemenow" runat="server" aria-describedby="emailHelp" class="form-control input-style" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                         ...
                         <asp:Button ID="btnsavepdf" OnClick="btnpdf_Click" class="btn btn-primary btn-style mt-4" OnClientClick="return confirm('Would you like to save a claiming stub?')" runat="server" Text="Save as Pdf" />
