<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="BarangayRegisterResident.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.BarangayRegisterResident" %>
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Registered Users</label>
                        <div class="input-group">
                        <asp:textbox ID="txtSearch" runat="server" placeholder="Search Barangay Resident" aria-describedby="emailHelp" class="form-control input-style" AutoPostBack="True" />
                            </div>
                        </div>
                          <asp:Button ID="Btnserachbar" class="btn btn-primary btn-style mt-4" OnClick="Btnserachbar_Click" runat="server" Text="Search" />
                    <br />
                    <br />
                     <asp:Repeater ID="rptregisterdusers" runat="server">
                            <HeaderTemplate>
                            ...
                            <ItemTemplate>
                                    <tbody>
                                        <tr>
                                            <td style="width: 17%">
                                                <asp:Label ID="Label2" Text='<%#Eval("residentcontrolnumber") %>' runat="server" />
                                            </td>
                                            <td style="width: 24%">
                                           ...
                                           <td style="width: 17%">
                                                <asp:Label ID="Label1" Text='<%#Eval("tbl_address") %>' runat="server" />
                                            </td>
                                            <td style="width: 11%">
                                                <asp:Label ID="lbldateregister" Text='<%#Eval("date") %>' runat="server" />
                                            </td>
                                            <td style="width: 11%">
                                              <asp:linkbutton text="Review" ID="review" runat="server" class="btn btn-success" OnClick="review_Click"/>
