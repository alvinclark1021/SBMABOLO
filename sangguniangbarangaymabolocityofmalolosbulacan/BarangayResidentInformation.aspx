<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="BarangayResidentInformation.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.BarangayResidentInformation" %>
            ...
            <ul>
              <li class="dropdown profile_details_drop">
                ...
                <ul class="dropdown-menu drp-mnu" aria-labelledby="dropdownMenu3">
                  ...
                  <li><asp:LinkButton ID="linkprofile" OnClick="linkprofile_Click1" class="fa fa-user" runat="server"> My Profile</asp:LinkButton> </li>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Resident Profile<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Resident Profile</label>
                        <div class="input-group">
                             <asp:textbox ID="txtSearch" runat="server" placeholder="Resident" aria-describedby="emailHelp" class="form-control input-style"  AutoPostBack="True" OnTextChanged="txtSearch_TextChanged" />
                            </div>
                        </div>
                                 ...
                                 <table class="table table-sm table-hover">
                                    <thead class="text-primary">
                                        <tr>
                                            ...
                                            <th style="border: 1px solid black">Resident Image</th>
                            ...
                            <ItemTemplate>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width: 10%">
                                                <img src='ResidentImageprofile/<%#Eval("tbl_residentimage") %>' width="170" />
                                            </td>
