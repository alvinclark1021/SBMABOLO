...
{
    public partial class PermittocontrustReadytopicup : System.Web.UI.Page
    {
        SqlCommand com;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string query = "select * from PermittocontrustInformation Where Status='Ready To Pickup' ORDER BY datepickup DESC";
        ...
        {
            string querys = "SELECT * FROM PermittocontrustInformation WHERE (Status='Ready To Pickup' OR fullname LIKE '%" + txtSearch.Text + "%' OR datepickup LIKE '%" + txtSearch.Text + "%') AND Status != 'Pending' AND Status != 'Pending'";
        ...
        {
            string querys = "SELECT * FROM PermittocontrustInformation WHERE (Status='Ready To Pickup' OR fullname LIKE '%" + txtSearch.Text + "%' OR datepickup LIKE '%" + txtSearch.Text + "%') AND Status != 'Pending' AND Status != 'ClaimDocuments'";
        ...
        protected void lnkreadyforpicup_Click(object sender, EventArgs e)
        {
            ...
            {
                cons.Open();
                SqlCommand cmd = new SqlCommand("UPDATE PermittocontrustInformation SET Status = 'Claim Document' WHERE ID = @ID", cons);
