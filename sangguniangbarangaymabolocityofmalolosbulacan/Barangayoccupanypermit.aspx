<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="Barangayoccupanypermit.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.Barangayoccupanypermit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <title>Occupancy Permit - Sangguniang Barangay Mabolo, Malolos City</title>
...
<div class="main-content">
    <asp:Label ID="lbldatemenow" runat="server" ForeColor="White" Visible="false" Text="Label"></asp:Label>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Request Document For Occupancy Permit</li>
      </ol>
    </nav>
   ...
   <asp:Label ID="lblID" runat="server" Text="Label" Visible="false" ForeColor="White"></asp:Label>
              ...
              <asp:Label ID="lblBarangayClearance" runat="server" Visible="false" Text="Barangay Permit Occupancy" ForeColor="White"></asp:Label>
       
     <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Occupancy Permit<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Document No</label>
                        <div class="input-group">
                          <asp:TextBox ID="txtocccontrolnumber" aria-describedby="emailHelp" class="form-control input-style" placeholder="Fullname" required="" runat="server" ReadOnly="True"></asp:TextBox>                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Name: </label>
                        <div class="input-group">
                         <asp:TextBox ID="txtfullname"  placeholder="Fullname" required="" aria-describedby="emailHelp" class="form-control input-style" runat="server" ReadOnly="True"></asp:TextBox>                         </div>
                    </div>
                       
                 
                  </div>

                     <div id="sadf" runat="server" visible="false">
                       <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Mobile Number</label>
                        <div class="input-group">
                         <asp:TextBox ID="txtmobilenumber" aria-describedby="emailHelp" class="form-control input-style" placeholder="Mobile Number" Rows="11" Width="100%" Height="32px" onkeypress="return this.value.length<=11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required="" runat="server" ReadOnly="True"></asp:TextBox>
                        ...
                        <div class="input-group">
                            <asp:TextBox ID="txtemail" aria-describedby="emailHelp" class="form-control input-style" placeholder="Email" onfocus="this.type='email'" Width="100%" Height="32px" required="" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group"> 
                              <asp:TextBox ID="txtaddress" aria-describedby="emailHelp" class="form-control input-style" placeholder="barangay position"  runat="server" ReadOnly="True"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div id="san" visible="false" runat="server" >
                               <asp:Button ID="Button1" class="btn btn-primary btn-style mt-4" OnClick="Button1_Click" OnClientClick="return confirm('Do you want to add purpose?')" runat="server" Text="Add Purposes" />

                        </div>
                        <div id="dad" runat="server" visible="false">
                            <div class="form-group">
                                <asp:TextBox ID="txtaddpurpose" placeholder="Add Purpose" aria-describedby="emailHelp" class="form-control input-style" runat="server"></asp:TextBox>

                            </div>
                            <asp:Button ID="Bntsubmitpurpose" class="btn btn-primary btn-style mt-4" OnClick="Bntsubmitpurpose_Click" OnClientClick="return confirm('Do you want to add purpose?')" runat="server" Text="Add Purposes" />
                        </div>
                    <br />
                            <br />
                            <br />
                    <div class="form-group">
                                 ...
                                 <br />
                                 <h5>Please to upload your Sketch your Planning</h5>
                                  <asp:FileUpload ID="FileUpload1" aria-describedby="emailHelp" class="form-control input-style" runat="server" required=""  />
                                  <asp:Label ID="lblplanning" Visible="false" runat="server" Text="Label"></asp:Label>
                                  <br />
                                 <p>File size: maximum 2 MB</p>
                                 <p>File extension: .JPEG, .PNG</p>
             
                              </div>               
                                       <asp:Button ID="btnsubmit" class="btn btn-primary btn-style mt-4" OnClick="btnsubmit_Click" OnClientClick="return confirm('Do you want to request document?')" runat="server" Text="Submit" />
                            </div>
