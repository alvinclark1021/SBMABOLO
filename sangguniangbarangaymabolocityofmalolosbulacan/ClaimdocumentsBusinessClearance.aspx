<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="ClaimdocumentsBusinessClearance.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ClaimdocumentsBusinessClearance" %>
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                   ...
                   <asp:Button ID="Btnserachbar" class="btn btn-primary btn-style mt-4" OnClick="Btnserachbar_Click" runat="server" Text="Search" />
                       <br />
                    <br />
                     <asp:GridView ID="rptclaimdocumentsbusinessclearance" AutoGenerateColumns="false" CssClass="table" runat="server">
                        <Columns>
                            <asp:BoundField HeaderText="Control No" DataField="barangaybusinesscontrolno" />
                            <asp:BoundField HeaderText="Name" DataField="operatormanager" />
