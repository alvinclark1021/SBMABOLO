<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="goodmoralrepi.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.goodmoralrepi" %>
...
<div class="main-content">
  ...
  <div class="container-fluid content-top-gap">
   ...
   <asp:Label ID="lblID" runat="server" Text="Label" Visible="false" ForeColor="White"></asp:Label>
              ...
              <asp:Label ID="lblBarangayClearance" runat="server" Visible="false" Text="Barangay Good Mornal" ForeColor="White"></asp:Label>
       <!-- forms -->
        <section class="forms">
            <!-- forms 1 -->
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Request Document Good Mornal<span></span></h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:Label ID="lbldatemenow" runat="server" aria-describedby="emailHelp" class="form-control input-style" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                              ...
                              <asp:Button ID="btnsavepdf" class="btn btn-primary btn-style mt-4" OnClick="btnsavepdf_Click"  runat="server" Text="Save as Pdf" />
                          <br />
                         <br />
                         
                         <asp:Button ID="btnok" OnClick="btnok_Click" class="btn btn-primary btn-style mt-4"  runat="server" Text="Ok" />
                            </form>
                        </div>
            </div>
            <!-- //forms 1 -->
