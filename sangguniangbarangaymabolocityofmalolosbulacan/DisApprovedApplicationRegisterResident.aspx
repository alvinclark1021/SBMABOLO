<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="DisApprovedApplicationRegisterResident.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.DisApprovedApplicationRegisterResident" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

  <title>Denied Register Users- Sangguniang Barangay Mabolo, Malolos City</title>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Denied Register Users</li>
      </ol>
    </nav>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Denied Register Users<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Denied Register Users</label>
                        <div class="input-group">
                        <asp:textbox ID="txtSearch" runat="server" placeholder="Register Users" required="" aria-describedby="emailHelp" AutoPostBack="true" class="form-control input-style" OnTextChanged="txtSearch_TextChanged"  />
                            </div>
                        </div>
                    ...
                    <asp:Repeater ID="rptDisapprovedusers" runat="server">
                            <HeaderTemplate>
                                 <table class="table table-sm table-hover">
                                    <thead class="text-primary">
                                        <tr>
                                            <th style="border: 1px solid black">Control No</th>
                                            <th style="border: 1px solid black">Name</th>
                                            <th style="border: 1px solid black">Status</th>
                                            <th style="border: 1px solid black">Reason</th>
                                            <th style="border: 1px solid black">Valid ID</th>
                            ...
                            <ItemTemplate>
                                    <tbody>
                                        <tr>
                                             <td style="width: 10%">
                                                <asp:Label ID="Label1" Text='<%#Eval("residentcontrolnumber") %>' runat="server" />
                                            </td>
                                            <td style="width: 24%">
                                                <asp:Label ID="lblid" Text='<%#Eval("ID") %>' runat="server" Visible="false" />
                                                <asp:Label ID="lblname" Text='<%#Eval("tbl_name") %>' runat="server" />
                                            </td>
                                            <td style="width: 8%">
                                                <asp:Label ID="lblStatus" Text='<%#Eval("Status") %>' runat="server" />
                                            </td>
                                            <td style="width: 15%">
                                                <asp:Label ID="lblpurpose" Text='<%#Eval("Purposeandreason") %>' runat="server" />
                                            </td>
                                             <td style="width: 11%">
                                                <img src='Pendingregistationresident/<%#Eval("tbl_validid") %>' width="140" />
                                            </td>
                                            <td style="width: 20%">
                                                <asp:linkbutton text="Review" ID="lnkreviewwith24hours" runat="server" class="btn btn-outline-secondary" CssClass="btn-success" OnClick="lnkreviewwith24hours_Click"  />
                                            </td>
                                        </tr>
                            </ItemTemplate>
                            <FooterTemplate>
