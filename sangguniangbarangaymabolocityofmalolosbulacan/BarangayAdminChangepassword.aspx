<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="BarangayAdminChangepassword.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.BarangayAdminChangepassword" %>
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                    ...
                    <script type="text/javascript">
                        ...
                        <asp:Button ID="btnchangepassword" class="btn btn-primary btn-style mt-4" OnClick="btnchangepassword_Click" runat="server" Text="Change Password" />
