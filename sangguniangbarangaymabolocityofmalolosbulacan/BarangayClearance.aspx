<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="BarangayClearance.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.BarangayClearance" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Request Document For Barangay Clearance</li>
      </ol>
    </nav>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Barangay Clearance<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Document No</label>
                        <div class="input-group">
                         <asp:TextBox ID="txtcontrolnumber" placeholder="Controlnumber" required="" aria-describedby="emailHelp" class="form-control input-style" runat="server" ReadOnly="True"></asp:TextBox>                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                    <asp:TextBox ID="txtmobilenumber" aria-describedby="emailHelp" class="form-control input-style" placeholder="Mobile Number" Rows="11" onkeypress="return this.value.length<=11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required="" runat="server" ReadOnly="True"></asp:TextBox>                        </div>
                    </div>
                    <div id="sa" runat="server" visible="false" class="form-group">
                        <label for="exampleInputPassword1"  class="input__label">Email: </label>
                        <div class="input-group">
                    <asp:TextBox ID="txtemail" placeholder="Email" onfocus="this.type='email'" aria-describedby="emailHelp" class="form-control input-style" required="" runat="server" ReadOnly="True"></asp:TextBox>           
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div id="divpurpose" runat="server" class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Select Purpose:</label>
                        <asp:DropDownList ID="Droppupose" OnSelectedIndexChanged="Droppupose_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control input-style">
                        </asp:DropDownList>
                    </div>

                    <div id="divaddpurpose" visible="false"  runat="server" class="form-group" >
                        <label for="exampleInputPassword1" class="input__label">Other Purpose:</label>
                        <div class="form-group">
                  
                            <asp:TextBox ID="txtOtherOption" runat="server" CssClass="form-control input-style"></asp:TextBox>
                        </div>
                    </div>
                    <div id="divbuttonvissible"  runat="server" class="form-group" >
                            <asp:Button ID="btnAddPurpose" runat="server" CssClass="btn btn-primary btn-style mt-4" Text="Add other purposes" OnClick="btnAddPurpose_Click" Width="209px" />
                            ...
                            <div class="form-group">
                                ...
                                <br />
                                <p>2 by 2 Image to upload</p>

                                <asp:FileUpload ID="FileUpload1" aria-describedby="emailHelp" class="form-control input-style" runat="server"   />
                             ...
                             <asp:Button ID="btnsubmit" class="btn btn-primary btn-style mt-4" OnClick="btnsubmit_Click" ClientIDMode="Static" OnClientClick="return confirm('Would you like to request a document?')" runat="server" Text="Submit" />
                                    </div>
                            </div>
