<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="excavationcuttingpermitclaim.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.excavationcuttingpermitclaim" %>
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                   ...
                   <asp:Button ID="Btnserachbar" class="btn btn-primary btn-style mt-4" OnClick="Btnserachbar_Click" runat="server" Text="Search" />
                       <br />
                    <br />
                     <asp:GridView ID="rptexcavationcuttingpermit" AutoGenerateColumns="false" CssClass="table" runat="server">
                        <Columns>
