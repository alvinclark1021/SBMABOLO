<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="Certificationofindigency.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.Certificationofindigency" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Request Document For Barangay Indigency</li>
      </ol>
    </nav>
   ...
   <asp:Label ID="lblID" runat="server" Text="Label" Visible="false" ForeColor="White"></asp:Label>
              ...
              <asp:Label ID="lblBarangayClearance" runat="server" Visible="false" Text="Barangay Indigency" ForeColor="White"></asp:Label>
       <!-- forms -->
        <section class="forms">
            <!-- forms 1 -->
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Barangay Indigency<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Document No</label>
                        <div class="input-group">
                             <asp:TextBox ID="txtbarangaycontrolnumber" aria-describedby="emailHelp" class="form-control input-style" placeholder="Fullname" required="" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="ds" runat="server" visible="false" class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Mobile Number</label>
                        <div class="input-group">
                            <asp:TextBox ID="txtmobilenumber" aria-describedby="emailHelp" class="form-control input-style" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                           
                    <div id="dasf" runat="server" visible="false">
                        <div id="dsa" runat="server" visible="false" class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Email: </label>
                        <div class="input-group">
                          <asp:TextBox ID="txtemail" aria-describedby="emailHelp" class="form-control input-style" placeholder="Email Address"  runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                        </div>
                         </div>
                            </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                 <asp:TextBox ID="txtaddress" aria-describedby="emailHelp" class="form-control input-style" placeholder="Mobile Number"  runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
