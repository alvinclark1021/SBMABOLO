<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="permittoconstruct.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.permittoconstruct" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Request Document For Permit To Construct</li>
      </ol>
    </nav>
   ...
   <asp:Label ID="lblID" runat="server" Text="Label" Visible="false" ForeColor="White"></asp:Label>
              ...
              <asp:Label ID="lblBarangayClearance" runat="server" Visible="false" Text="Barangay Permit to Contruct" ForeColor="White"></asp:Label>
       <!-- forms -->
        <section class="forms">
            <!-- forms 1 -->
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <asp:TextBox ID="txtpermittoconstruct" aria-describedby="emailHelp" class="form-control input-style" placeholder="Fullname"  required="" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        ...
                        <div id="dad" runat="server" visible="false">
                            <div id="das" runat="server" visible="false" class="form-group">
                    ...
                    <div id="dasa" runat="server" visible="false" class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Email: </label>
                        <div class="input-group">
                            <asp:TextBox ID="txtemail" aria-describedby="emailHelp" class="form-control input-style" placeholder="Email"  onfocus="this.type='email'" required="" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                        </div>
                        </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          <asp:TextBox ID="txtaddress" aria-describedby="emailHelp" class="form-control input-style" placeholder="Contact Number"  runat="server" ReadOnly="True"></asp:TextBox>                      </div>
                        ...
                        <div id="good" visible="false" runat="server">
                         <asp:Button ID="Button1" class="btn btn-primary btn-style mt-4" OnClick="Button1_Click" OnClientClick="return confirm('Do you want to request a document?')" runat="server" Text="Add Purposes" />

                        </div>
                          <div id="sadme" runat="server" visible="false">
                                <div class="form-group">
                                 <asp:TextBox ID="txtaddpurposeme" placeholder="Purpose" aria-describedby="emailHelp" class="form-control input-style"  runat="server"></asp:TextBox>
            </div>
                           <asp:Button ID="btnaddpurpose" class="btn btn-primary btn-style mt-4" OnClick="btnaddpurpose_Click" OnClientClick="return confirm('Do you want to Add Request document?')" runat="server" Text="Add Purposes" />
                          </div>
                             <br />
                            <br />
                            <br />
                        <div class="form-group">
                            ...
                            <br />
                            <h5>Please Upload your planning</h5>
                            <br />
                            <asp:FileUpload ID="FileUpload1" aria-describedby="emailHelp" class="form-control input-style" required="" runat="server" />
                            <br />
                            ...
                            <p>File extension: .JPEG, .PNG</p>
                              ...
                              <asp:Button ID="btnsubmit" class="btn btn-primary btn-style mt-4" OnClick="btnsubmit_Click" OnClientClick="return confirm('Would you like to request a document?')" runat="server" Text="Submit" />                            </form>
                        </div>
            </div>
            <!-- //forms 1 -->
