<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="Cerficationofresidency.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.Cerficationofresidency" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Request Document For Barangay Residency</li>
      </ol>
    </nav>
   ...
   <asp:Label ID="lblID" runat="server" Text="Label" Visible="false" ForeColor="White"></asp:Label>
              <asp:Label ID="lbldatemenow" runat="server" Text="Label" Visible="false" ForeColor="White"></asp:Label>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Request Document<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Document No</label>
                        <div class="input-group">
                          <asp:TextBox ID="txtresidency" aria-describedby="emailHelp" class="form-control input-style"  placeholder="Fullname" required="" runat="server" ReadOnly="True"></asp:TextBox>                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Name: </label>
                        <div class="input-group">
                            <asp:TextBox ID="txtfullname" aria-describedby="emailHelp" class="form-control input-style"  placeholder="Fullname" required="" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                        <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Mobile Number</label>
                        <div class="input-group">
                            <asp:TextBox ID="txtmobilenumber"  aria-describedby="emailHelp" class="form-control input-style"  placeholder="barangay position"  runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Email: </label>
                        <div class="input-group">
                   <asp:TextBox ID="txtemail" aria-describedby="emailHelp" class="form-control input-style" onfocus="this.type='email'" required="" runat="server" ReadOnly="True"></asp:TextBox>             </div>
                    </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Address: </label>
                            <div class="input-group">
                                <asp:TextBox ID="txtaddress" aria-describedby="emailHelp" class="form-control input-style" placeholder="Contact Number" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:DropDownList ID="DropDownList1" aria-describedby="emailHelp" class="form-control input-style" runat="server">
                                        ...
                                        <asp:ListItem>SK Scholarship</asp:ListItem>
                                        <asp:ListItem>opening a business establishment.</asp:ListItem>
                                        <asp:ListItem> business or financial transactions such as lending, loan or financing.</asp:ListItem>
                                        <asp:ListItem>certify that you are living or residing in a certain barangay.</asp:ListItem>
                                        <asp:ListItem>Important transactions</asp:ListItem>
                                    </asp:DropDownList>
                                ...
                                <div class="form-group">
                                    <br />
                                    <asp:RequiredFieldValidator ID="rfvpurpose" runat="server" ErrorMessage="Please Select" ControlToValidate="DropDownList1" ForeColor="Red" SetFocusOnError="True" InitialValue="0"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group">
                                    <asp:TextBox ID="txtpurposes" placeholder="Purpose" aria-describedby="emailHelp" class="form-control input-style" runat="server"></asp:TextBox>
                                </div>

                                <asp:Button ID="btnsubmitpurpose" class="btn btn-primary btn-style mt-4" OnClick="btnsubmitpurpose_Click" ClientIDMode="Static" OnClientClick="return confirm('Do You want add purpose?')" runat="server" Text="Add Purpose" />
                                <br />
                                <br />
                                <br />
                                <div class="form-group">
                                    <label for="exampleInputPassword1" class="input__label">Upload ID : </label>
                                    <br />
                                    <asp:FileUpload ID="FileUpload1" aria-describedby="emailHelp" class="form-control input-style" runat="server" required="" />
                                    <br />
                                    <asp:Label ID="lblvalidaddress" Visible="false" runat="server" Text="Label"></asp:Label>
                                    <br />
