<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="ConcernsMessageUser.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ConcernsMessageUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

  <title>Concers Message- Sangguniang Barangay Mabolo, Malolos City</title>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Concerns Message</li>
      </ol>
    </nav>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Concerns Message<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Concerns Message</label>
                        <div class="input-group">
                              <asp:textbox ID="txtSearch" runat="server" placeholder="Concern Message" required="" aria-describedby="emailHelp" class="form-control input-style" AutoPostBack="True" OnTextChanged="txtSearch_TextChanged"  />                        
                            </div>
                        </div>
                                 ...
                                 <table class="table table-sm table-hover">
                                    <thead class="text-primary">
                                        <tr>
                                            ...
                                            <th style="border: 1px solid black">Concern Message</th>
                                        ...
                                        <tr>
                                            <td style="width: 16%">
                                                <asp:Label ID="lblid" Text='<%#Eval("ID") %>' runat="server" Visible="false" />
                                                 <asp:Label ID="lblemail" Text='<%#Eval("Name") %>' runat="server" /> 
                                            </td>
                                            ...
                                            <td style="width: 15%">
                                                <asp:Label ID="lbldatetoday" Text='<%#Eval("datetoday") %>' runat="server" />
                                            </td>
