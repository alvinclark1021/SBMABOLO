...
{
    public partial class PermitToConstructRecipient : System.Web.UI.Page
    {
        ...
        protected void btnsavepdf_Click(object sender, EventArgs e)
        {
            ...
            table.AddCell("Permit to Construct  No:");
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=Permittoconstructrecipient.pdf");
