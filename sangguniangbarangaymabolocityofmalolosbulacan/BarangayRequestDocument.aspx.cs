...
{
    public partial class BarangayRequestDocument : System.Web.UI.Page
    {
        ...
        private void LoadProducts()
        {
            ...
            string query = "select * from BarangayClearanceInfomation Where Status='Pending' ORDER BY datepickup DESC ";
        ...
        {
            string querys = "SELECT * FROM BarangayClearanceInfomation WHERE (Status='Pending' OR fullname LIKE '%" + txtSearch.Text + "%' OR datepickup LIKE '%" + txtSearch.Text + "%') AND Status != 'ClaimDocuments'";
