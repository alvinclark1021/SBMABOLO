<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="barangayindigencyClaim.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.barangayindigencyClaim" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Claimed Documents</li>
      </ol>
    </nav>
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                   ...
                   <asp:Button ID="Btnserachbar" class="btn btn-primary btn-style mt-4" OnClick="Btnserachbar_Click" runat="server" Text="Search" />
                       <br />
                    <br />
                     <asp:GridView ID="rptbaranagyinden" AutoGenerateColumns="false" CssClass="table" runat="server">
                        <Columns>
                            <asp:BoundField HeaderText="Control No" DataField="barangayControlnumber" />
                            <asp:BoundField HeaderText="Name" DataField="fullnames" />
