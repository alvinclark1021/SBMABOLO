<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="ReviewBusinessClearanceApproved.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ReviewBusinessClearanceApproved" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <title>Business Clearance Review Approved</title>
      ...
      <!-- forms 1 -->
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                 ...
                 <asp:Button ID="Ok" OnClick="Ok_Click" class="btn btn-primary btn-style mt-4" runat="server" Text="Ok" />
                    </form>
                </div>
            </div>
            <!-- //forms 1 -->
