<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="businessclearanceopticalreceipt.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.businessclearanceopticalreceipt" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Request Document For Barangay Business Clearance</li>
      </ol>
    </nav>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Request Document Barangay Business Clearance<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Document No</label>
                        <div class="input-group">
                           <asp:Label ID="lbltxtcontrolnumber" aria-describedby="emailHelp" class="form-control input-style" runat="server" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                        </div>
                        </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Business Category</label>
                        <div class="input-group">
                             <asp:Label ID="lblbusinesscategory" runat="server" aria-describedby="emailHelp" class="form-control input-style" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                        </div>
                            </div>
                        <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Business Name</label>
                        <div class="input-group">
                             <asp:Label ID="lblbusinessname" runat="server" aria-describedby="emailHelp" class="form-control input-style" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                        </div>
                            </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Business Address: </label>
                        <div class="input-group">
                           <asp:Label ID="lblcontactnumber" runat="server" aria-describedby="emailHelp" class="form-control input-style" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                        </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                         ...
                         <asp:Button ID="btnsavepdf" OnClick="btnsavepdf_Click" class="btn btn-primary btn-style mt-4" OnClientClick="return confirm('Would you like to save a claiming stub?')"  runat="server" Text="Save as Pdf" />
                         <br />
                         <br />
