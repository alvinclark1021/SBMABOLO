<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="BarangayRequestDocuments.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.BarangayRequestDocuments" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Request Document For Barangay Good Mornal</li>
      </ol>
    </nav>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Good Mornal<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Document No</label>
                        <div class="input-group">
                    <asp:TextBox ID="txtgoodmoral" placeholder="Fullname" aria-describedby="emailHelp" class="form-control input-style" required="" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <asp:TextBox ID="txtmobilenumber" aria-describedby="emailHelp" class="form-control input-style" placeholder="Mobile Number" Rows="11" onkeypress="return this.value.length<=11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required="" runat="server" ReadOnly="True"></asp:TextBox>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                    <asp:TextBox ID="txtemail" placeholder="Email" onfocus="this.type='email'" aria-describedby="emailHelp" class="form-control input-style" required="" runat="server" ReadOnly="True"></asp:TextBox>                </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div clss="fornm-group">
                          <asp:RequiredFieldValidator ID="rfvpurpose" runat="server" ErrorMessage="Please Select" ControlToValidate="DropDownList1" ForeColor="Red" SetFocusOnError="True" InitialValue="0"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1" class="input__label">if not choose please add your purpose </label>
                                 <asp:TextBox ID="txtaddpurpose" placeholder="Purpose" aria-describedby="emailHelp" class="form-control input-style"  runat="server"></asp:TextBox>
            </div>
                           <asp:Button ID="btnaddpurpose" class="btn btn-primary btn-style mt-4" OnClick="btnaddpurpose_Click" OnClientClick="return confirm('Do you want to Add Purpose?')" runat="server" Text="Submit" />
                             <br />
                            <br />
                            <br />
                            <div class="form-group">
                                 ...
                                 <br />
                                <p>please upload your prove address or any valid address in barangay mabolo</p> 
