<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="barangayindigency.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.barangayindigency" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Recipient for Barangay Indigency</li>
      </ol>
    </nav>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Recipient for barangay indigency<span></span></h3>
                </div>
                <div class="card-body">
