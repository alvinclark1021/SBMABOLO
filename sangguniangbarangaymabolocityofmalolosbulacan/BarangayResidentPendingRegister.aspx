<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="BarangayResidentPendingRegister.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.BarangayResidentPendingRegister" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Pending Register Users</li>
      </ol>
    </nav>
        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Pending Register Users<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Pending Register Users</label>
                        <div class="input-group">
                            <asp:textbox ID="txtSearch" runat="server" placeholder="Register Users" required="" aria-describedby="emailHelp" class="form-control input-style" AutoPostBack="True" OnTextChanged="txtSearch_TextChanged"  />
                        </div>
                    </div>
                   <asp:Button ID="Btnserachbar" class="btn btn-primary btn-style mt-4" OnClick="Btnserachbar_Click" runat="server" Text="Search" />
                       <br />
                    <br />
                     <asp:Repeater ID="rptresidentpending" runat="server">
                            <HeaderTemplate>
                            ...
                            <ItemTemplate>
                                    <tbody>
                                        <tr>
                                            <td style="width: 13%">
                                              <asp:Label ID="lblidno" Text='<%#Eval("residentcontrolnumber") %>' runat="server" /> 
                                            </td>
                                            <td style="width: 24%">
                                            ...
                                            <td style="width: 9%">
                                                <asp:Label ID="lbldateregister" Text='<%#Eval("date") %>' runat="server" />
                                            </td>
                                            <td style="width: 8%">
                                            ...
                                            <td style="width: 13%">
                                                <asp:linkbutton text="Review" ID="lnkreviewwith24hours" runat="server" class="btn btn-success" CssClass="btn-success" OnClick="lnkreviewwith24hours_Click"  />
                                            </td>
                                        </tr>
                            </ItemTemplate>
                            <FooterTemplate>
