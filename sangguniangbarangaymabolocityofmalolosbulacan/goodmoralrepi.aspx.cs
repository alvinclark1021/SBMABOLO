...
{
    public partial class goodmoralrepi : System.Web.UI.Page
    {
        ...
        protected void btnsavepdf_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=GoodMornal.pdf");
