<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="ReviewValidid.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ReviewValidid" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

  <title>Valid Id- Sangguniang Barangay Mabolo, Malolos City</title>
