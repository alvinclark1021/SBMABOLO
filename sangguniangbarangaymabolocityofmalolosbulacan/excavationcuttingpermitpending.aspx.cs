...
{
    public partial class excavationcuttingpermitpending : System.Web.UI.Page
    {
        ...
        private void LoadProducts()
        {
            ...
            string query = "select * from ExcavationCuttingInformation Where Status='Pending' ORDER BY datepickup DESC";
        ...
        {
            string querys = "SELECT * FROM ExcavationCuttingInformation WHERE (Status='Pending' OR fullname LIKE '%" + txtSearch.Text + "%' OR datepickup LIKE '%" + txtSearch.Text + "%') AND Status != 'ClaimDocuments'";
        ...
        protected void lnkreviewwith24hours_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("CuttingPermit.aspx");
        }
    }
}