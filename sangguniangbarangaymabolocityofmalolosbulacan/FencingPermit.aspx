<%@ Page Title="" Language="C#" MasterPageFile="~/ResidentDashboard.Master" AutoEventWireup="true" CodeBehind="FencingPermit.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.FencingPermit" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Barangay Fencing Permit</li>
      </ol>
    </nav>
   ...
   <asp:Label ID="lblID" runat="server" Text="Label" Visible="false" ForeColor="White"></asp:Label>
              ...
              <asp:Label ID="lblBarangayClearance" runat="server" Visible="false" Text="Barangay Fencing Permit" ForeColor="White"></asp:Label>
       <!-- forms -->
        <section class="forms">
            <!-- forms 1 -->
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Fencing Permit<span></span></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="input__label">Document No</label>
                        <div class="input-group">
                            <asp:TextBox ID="txtocccontrolnumber" aria-describedby="emailHelp" class="form-control input-style" runat="server" placeholder="Fullname" required=""  runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        ...
                        <div id="sas" runat="server" visible="false" class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div id="divaddpurposess" runat="server" class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Purpose : </label>
                            <div class="input-group">
                                <asp:DropDownList ID="Droppupose" class="form-control input-style" runat="server" ></asp:DropDownList>

                            </div>
                            </div>
                         <div id="divepurposess" visible="false" runat="server" class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Add Other Purposes : </label>
                            <div class="input-group">
                              <asp:TextBox ID="txtaddotherpurpose" aria-describedby="emailHelp" class="form-control input-style" placeholder="Contact Number"  runat="server" ReadOnly="True"></asp:TextBox>                      </div>
                            </div>
                            ...
                            <br />
                            <asp:Button ID="btnsubmit" class="btn btn-primary btn-style mt-4" OnClick="btnsubmit_Click" OnClientClick="return confirm('Would you like to request a document?')" runat="server" Text="Submit" />
