<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="SBMResidentInformation.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.SBMResidentInformation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

  <title> Register Users- Sangguniang Barangay Mabolo, Malolos City</title>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Resident Information</li>
      </ol>
    </nav>
    ...
    <!-- forms 1 -->
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Resident Information <span></span></h3>
                </div>
                <div class="card-body">
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Gender: </label>
                          <asp:Label ID="lblgender" runat="server" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Voter Registerd in Barangay Mabolo: </label>
                          <asp:Label ID="lblvoterregister" runat="server" Text="Label" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                        </div>
                         <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Voter Registerd in Barangay Mabolo: </label>
