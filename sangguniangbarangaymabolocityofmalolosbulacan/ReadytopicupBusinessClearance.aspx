<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="ReadytopicupBusinessClearance.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.ReadytopicupBusinessClearance" %>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 20%">
                                              ...
                                              <asp:Label ID="lblidno" Text='<%#Eval("barangaybusinesscontrolno") %>' runat="server" /> 
                                            </td>
                                            <td style="width: 24%">
                                               
                                                <asp:Label ID="lblname" Text='<%#Eval("operatormanager") %>' runat="server" />
                                            </td>
