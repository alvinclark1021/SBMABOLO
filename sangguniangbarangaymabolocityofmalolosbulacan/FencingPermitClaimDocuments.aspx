<%@ Page Title="" Language="C#" MasterPageFile="~/BarangayAdminDashboard.Master" AutoEventWireup="true" CodeBehind="FencingPermitClaimDocuments.aspx.cs" Inherits="sangguniangbarangaymabolocityofmalolosbulacan.FencingPermitClaimDocuments" %>
  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Fencing Permit</li>
      </ol>
    </nav>
            ...
            <div class="card card_border py-2 mb-4">
                ...
                <div class="card-body">
                   ...
                   <asp:Button ID="Btnserachbar" class="btn btn-primary btn-style mt-4" OnClick="Btnserachbar_Click" runat="server" Text="Search" />
                       <br />
                    <br />
                     <asp:GridView ID="rptclaimdocumentsfencingpermit" AutoGenerateColumns="false" CssClass="table" runat="server">
                        <Columns>
                            <asp:BoundField HeaderText="Control No" DataField="barangayControlnumbers" />
